...
The API to construct asynchronous instruments MUST accept the following
parameters:
...
Every currently registered Callback associated with a set of instruments MUST be
