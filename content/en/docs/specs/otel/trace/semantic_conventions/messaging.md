...
A source represents an entity within messaging system messages are consumed
...
A message _creation context_ allows correlating producers with consumers of a
