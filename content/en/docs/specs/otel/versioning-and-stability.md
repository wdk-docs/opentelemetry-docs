...
The development of each signal follows a lifecycle: experimental, stable,
deprecated, removed.
...
**Exception:** in some languages, package managers may react poorly to
